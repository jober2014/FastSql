...
namespace Dapper
{
    ...
    static partial class SqlMapper
    {
        ...
        /// <summary>
        ///提供参数值的按名称查找IDynamicParameters延伸
        /// </summary>
        ...
        /// <summary>
        ///延伸与facitilies IDynamicParameters为在命令完成后，执行回调
        /// </summary>
...
#pragma warning restore 618
        ...
        /// 获取映射到一个给定值的显示文件内容
        /// </summary>
        [Obsolete("此方法仅供内部使用"), Browsable(false), EditorBrowsable(EditorBrowsableState.Never)]
        ...
        public partial class Identity : IEquatable<Identity>
        {
            ...
            /// <summary>
            /// Create an identity for use with DynamicParameters, 内部专用
            /// </summary>
...
this IDbConnection cnn, string sql, object param = null, IDbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null
        ...
        /// <summary>
        ///参数化SQL执行，并返回一个 <see cref="IDataReader"/>
        /// </summary>
        /// <returns>An <see cref="IDataReader"/> 可用于循环访问在SQL查询的结果.</returns>
        /// <remarks>
...
this IDbConnection cnn, string sql, object param = null, IDbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null
        ...
        /// <summary>
        /// 参数化SQL执行，并返回一个 cref="IDataReader"/>
        /// </summary>
        /// <returns>An <see cref="IDataReader"/> that can be used to iterate over the results of the SQL query.</returns>
        /// <remarks>
        /// This is typically used when the results of a query are not processed by Dapper, for example, used to fill a <see cref="DataTable"/>
...
#pragma warning restore 612, 618
    ...
    sealed partial class DbString : Dapper.SqlMapper.ICustomQueryParameter
    {
        ...
        /// <summary>
        /// Add the parameter to the command... 内部专用
        /// </summary>
    ...
    /// <summary>
    /// 实现自定义属性映射由用户提供的条件(通常是一些自定义属性的存在
    /// </summary>
    sealed partial class CustomPropertyTypeMap : SqlMapper.ITypeMap
    {
        ...
        /// <summary>
        /// 不是impelmeneted尽可能在所有情况下使用默认构造函数
        /// </summary>
